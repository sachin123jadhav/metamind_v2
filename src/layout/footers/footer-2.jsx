...
const footer_content = {
  ...
  footer_lisks: [
    ...
    },
    {
      ...
      delay: ".7s",
      links: [
        { name: "Cyber Security", link: "/about" },
        { name: "E-Commerce Development", link: "/service" },
        { name: "Digital Transformation Services", link: "#" },
        { name: "Software Product Development", link: "/price" },
        { name: "Software as a Service (SaaS)", link: "/blog" },
      ],
    },
  ],
  social_links: [
